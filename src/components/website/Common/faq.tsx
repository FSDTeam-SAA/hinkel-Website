...
const FAQS = [
  ...
  },
  {
    ...
    answer: "You can change your plan at any time through your account settings.",
  },
  {
    question: "What is your cancellation policy?",
    answer: "Our cancellation policy is flexible. You can cancel your subscription at any time.",
  },
  {
  ...
  },
  {
    ...
    answer: "You can change your email address in the account security settings.",
  },
]
    ...
    <section className="py-24 px-6 bg-white">
      <div className="container mx-auto max-w-3xl">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-gray-600 text-lg">Everything you need to know about the product and billing.</p>
        </div>
        ...
        <div className="mt-24 p-12 bg-[#FAF7F2] rounded-3xl text-center space-y-8">
