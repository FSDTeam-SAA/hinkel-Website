...
export function Hero() {
  const { data, isLoading: isContentLoading, error } = useContent({type:"seniors"});
...
console.log(statsData)
  ...
  if (error) {
    return <div className="h-[600px] flex items-center justify-center text-red-500">Error loading content, Please try again later!!</div>;
  }
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-8 pt-2">
            <div className="flex gap-3 items-center">
              <span className="text-4xl font-bold text-primary-foreground">{statsData?.totalUsersCount}+</span>
            ...
            <div className="flex gap-3 items-center">
              <span className="text-4xl font-bold text-primary-foreground">{statsData?.paidOrdersCount }+</span>
              <span className="text-xs font-semibold text-gray-500 leading-tight">
                Total
                <br />
                Book Created
